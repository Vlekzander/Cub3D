...
SOURCES = src/main.c	\
		  ...
		  src/map/free_map.c src/map/parse_map.c src/map/parse_map_content.c src/map/parse_map_data.c	\
		  ...
		  src/utils/free_ddarray.c src/utils/is_space.c src/utils/len_ddarray.c src/utils/read_file.c src/utils/strend.c src/utils/strtrim_end.c
OBJECTS = $(SOURCES:.c=.o)
DEPS = $(SOURCES:.c=.d)
NAME = cub3D
