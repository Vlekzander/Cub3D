...
SOURCES = src/main.c	\
		  src/color/blend_colors.c src/color/rgb.c src/color/rgba.c	\
		  src/error/print_error.c	\
		  src/game/draw_minimap.c src/game/free_game.c src/game/init_game.c	\
		  src/image/create_image.c src/image/draw_image.c src/image/free_image.c src/image/parse_tga.c src/image/put_pixel.c	\
